  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-slate-50/50 text-slate-900 font-sans antialiased">
        ...
        <footer className="mt-12 border-t border-slate-200 bg-white py-10 px-4">
          <div className="max-w-2xl mx-auto text-center space-y-4">
            <p className="text-xs font-bold uppercase tracking-widest text-slate-400">
              Burushaski Language Isolate ML Dataset Hub
            </p>

            {/* Interactive Icon Badges Grid */}
            ...
            <p className="text-xs text-slate-400 font-medium pt-2">
              Burushaski-to-English Translation ML Dataset Hub • Open-Source • © {new Date().getFullYear()}
            </p>
          </div>
        </footer>
      </div>
